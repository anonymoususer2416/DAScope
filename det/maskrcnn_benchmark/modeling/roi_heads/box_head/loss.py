...
class FastRCNNLossComputation(object):
    ...
    def subsample(self, proposals, targets, num_gts):
        ...
        # print("subsample targets: " + str(len(targets[0])))
        # print("subsample labels: " + str(len(labels[0])))
        print("labels/matched idx: " + str(len(labels)))
        # print('labels: ' + str(labels))
        
        sampled_pos_inds, sampled_neg_inds = self.fg_bg_sampler(labels, num_gts)
        
        print("num pos inds: " + str(torch.nonzero(sampled_pos_inds[0]).shape))
        print("num neg inds: " + str(torch.nonzero(sampled_neg_inds[0]).shape))
