...
class CombinedROIHeads(torch.nn.ModuleDict):
    ...
    def forward(self, features, proposals, targets=None, use_pseudo_labeling_weight='none', images=None, with_da_on=True):
        ...
        x, detections, loss_box, da_ins_feas, da_ins_labels, da_proposals = self.box(features, proposals, targets, use_pseudo_labeling_weight, images=images, with_da_on=with_da_on)
