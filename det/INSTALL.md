...
conda create --name dascope-mic-sada -y
conda activate dascope-mic-sada
...
pip install piqa ninja==1.10.2.3 yacs==0.1.8 cython==0.29.28 matplotlib==3.5.1 tqdm==4.63.0 opencv-python==4.5.5.64 numpy==1.22.3 torchfile pycocotools yacs
