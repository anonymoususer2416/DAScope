    ...
    if cfg.MODEL.DOMAIN_ADAPTATION_ON:
        ...
        if cfg.MODEL.MIC_ON:
            ...
            if cfg.FINETUNE:
                ...
                # # sanity check that weights have been changed
                # print(model.roi_heads.box.predictor.cls_score.weight)
                # print(model.roi_heads.box.predictor.bbox_pred.weight)
                # print(model_teacher.ema_model.roi_heads.box.predictor.cls_score.weight)
                # print(model_teacher.ema_model.roi_heads.box.predictor.bbox_pred.weight)

                model.reinit_output_layers(cfg)
                model_teacher.ema_model.reinit_output_layers(cfg)
